    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <a href="form_add_entreprise" class=""><button class="btn btn-primary"> <b><i class="fa fa-plus"></i> ENTREPRISE</b></button></a>
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Base des Entreprises/Prospects/Particuliers/Cibles</h3><br>
                            <hr>
                            <!--<a href="form_add_entreprise"><button class="btn btn-success"> <b><i class="fa fa-plus"></i> ENTREPRISE</b></button></a><br><br>-->
                            <div class="row">
                                <div class="col-xs-6">
                                <a href="entreprises" style="color:blue"><u>Rétablir
                                 <i class="fa fa-undo"></i></i></u></a> &emsp;&emsp; <label>Filtrer par:</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-3">
