<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <a href="form_add_contrat" class="mr-4 d-block"><button class="btn btn-primary"> 
                    <b><i class="fa fa-plus"></i> CONTRAT</b></button></a>
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                        <a href="contrat" style="color:blue"><u>Rétablir
                        <i class="fa fa-undo"></i></u></a> &emsp;&emsp; <label>Filtrer par:</label>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <!--<div class="card-tools d-flex aglin-items-center">
                ...
                <div class="card-body table-responsive">
                    ...
                    <thead>
                    <tr>
                        <th wire:click="setOrderField('titre_contrat')"><i class="fas fa-sort" aria-hidden="true"></i>Titre de contrat</th>
                        <th wire:click="setOrderField('nom_entreprise')"><i class="fas fa-sort" aria-hidden="true"></i>Entreprise</th>
                        <th wire:click="setOrderField('debut_contrat')"><i class="fas fa-sort" aria-hidden="true"></i>Début du contrat</th>
                        <th wire:click="setOrderField('fin_contrat')"><i class="fas fa-sort" aria-hidden="true"></i>Fin du contrat</th>
                        <th wire:click="setOrderField('montant')"><i class="fas fa-sort" aria-hidden="true"></i>Montant</th>	
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form role="form" action="edit_the_serv" method="post">
                                                            ...
                                                            <div class="modal-footer justify-beetwen">
                                                                <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Fermer</button>
